...
function GlobeSVG() {
  return (
    ...
    >
      ...
      {/* Grid lines */}
      <ellipse cx="100" cy="100" rx="40" ry="80" fill="none" stroke="#D2F4DC" strokeWidth="0.75" />
      <ellipse cx="100" cy="100" rx="80" ry="80" fill="none" stroke="#D2F4DC" strokeWidth="0.75" />
      <line x1="20" y1="100" x2="180" y2="100" stroke="#D2F4DC" strokeWidth="0.75" />
      <line x1="100" y1="20" x2="100" y2="180" stroke="#D2F4DC" strokeWidth="0.75" />
      <ellipse cx="100" cy="100" rx="80" ry="28" fill="none" stroke="#D2F4DC" strokeWidth="0.75" />

      {/* City dots — live */}
      <circle cx="116" cy="86" r="5" fill="#1FA958" opacity="0.9" />
      <circle cx="116" cy="86" r="9" fill="none" stroke="#1FA958" strokeWidth="1" opacity="0.25" />
      ...
      <circle cx="128" cy="77" r="3" fill="#6FD891" opacity="0.6" />
      <circle cx="140" cy="92" r="2.5" fill="#6FD891" opacity="0.5" />
      <circle cx="122" cy="95" r="2.5" fill="#6FD891" opacity="0.5" />
      <circle cx="112" cy="78" r="2"   fill="#6FD891" opacity="0.4" />
    </svg>
  );
}
